...
# ya que hay una diferencia entre mayuscula y minuscula. 
...
# de 10*2 daria 20 pero en la declaracion de abajo dice que al valor antes contenido se le reste 5 unidades (20 -5) dando asi el numero 15 
...
#Respuesta: X al final contiene el numero 8 ya que la suma que estaba abajo de la variable no afecta debido a que no se especifica 
# en donde se va a contener
...
#Respuesta: X al final contiene el numero 13 debido a que al final X contiene el resultado de la resta entre Y y Z el cual Y = 18 y Z = 5
# haciendo resta de variables dentro de otra variable. 
...
#Respuesta: X al final contiene el numero 25 esto debido a que en la declaracion de X+10 no se suma el 10 a los 25 contenido con aterioridad 
# esto debido a que està mal digitada debio ser (X+=10)
...
# 1:
100/5  #Respuesta:EL tipo de variable que se contiene es: float

#2:
7/2  #Respuesta:EL tipo de variable que se contiene es:float

#3:
7//2  #Respuesta:EL tipo de variable que se contiene es: int

#4:
7%2  #Respuesta:EL tipo de variable que se contiene es: int

#5:
"tiza"+"."  #Respuesta:EL tipo de variable que se contiene es: str

#6:
"hola"[1+1]  #Respuesta:EL tipo de variable que se contiene es: str

#7:
len("hola")  #Respuesta:EL tipo de variable que se contiene es: int

#8:
int("145")  #Respuesta:EL tipo de variable que se contiene es: int

#9:
float("145")  #Respuesta:EL tipo de variable que se contiene es: float

#10:
float(145)  #Respuesta:EL tipo de variable que se contiene es: float

#11:
str(32)  #Respuesta:EL tipo de variable que se contiene es: str

#12:
1+2!=3  #Respuesta:EL tipo de variable que se contiene es: False

#13:
177%2==0  #Respuesta:EL tipo de variable que se contiene es: False

#14:
len("nube")<=20  #Respuesta:EL tipo de variable que se contiene es: True

#15:
n=167/10  #Respuesta:La variable: 16.7

#16:
n=167//10  #Respuesta:La variable: 16

#17:
n=167%10  #Respuesta:La variable: 7

#18:
letra="a"  #Respuesta:La variable: a

#19:
saludo="hola"+letra  #Respuesta:La variable: holaa

#20:
C=saludo[0]  #Respuesta:La variable: h

#21:
C=saludo[1+3]  #Respuesta:La variable: a 

#22:
L=len(saludo)  #Respuesta:La variable: 5

#23:
C=saludo[len(saludo)-1]  #Respuesta:La variable: a

#24:
menor="a"<"b"  #Respuesta:La variable: True

#25:
D=1!=1  #Respuesta:La variable: False

#25:
D="cinta">= "canto"  #Respuesta:La variable: True

#27
c="z"+"a"+"paz"[0]  #Respuesta:La variable: "zap"

#28:
x=c[0]=="z"  #Respuesta:La variable: True

#29:
11-(4%2+10)  #Respuesta: No arroja error

#30:
"30"+2  #Respuesta: Arroja error (No se peuden sumar una variable in con una str)

#31
"30"+"2"  #Respuesta: No arroja error 

#32:
"hola"[len("hola")]  #Respuesta: Arroja error 

#33:
len(124)  #Respuesta: Arroja error porque el metodo len es un metodo para ina variable str

#34:
"hola"[len("fin")]  #Respuesta: No arroja error 

#35:
"hola"[11-(4%2+10)]  #Respuesta: No arroja error

#36:
int("4")  #Respuesta: No arroja error

#37:
int(4)  #Respuesta: No arroja error

#38:
int("z")  #Respuesta: Arroja error 

#39:
int("4.")  #Respuesta: Arroja error 

#40:
4<"f"  #Respuesta: Error de comparar un int con un str

#41:
"palabra"="rama"  #Respuesta: Arroja error

#42:
"palabra"=="rama"  #Respuesta: No arroja error (False)


#3.1 Ejercicios resueltos con tablas de verdad

#1:
not(True) #Respuesta: Muestra False

#2:
not(1+2!=3) #Respuesta: Muestra True

#3:
x=(len("jugar")>5) and (len("jugar")<10) #Respuesta: Muestra False 

#4:
"alto"[2]=="t" and x #Respuesta: Muestra False

#5:
842913%10!=3 and len("cafe")==3 #Respuesta: Muestra False

#6
0!=0 or "a"<"y" #Respuesta: Muestra True

#7:
True or int("50")>=50 #Respuesta: Muestra True

#8:
edad=20 
not(x) or edad%2==0 #Respuesta: Muestra True

#9:
es_cliente=False
not(es_cliente and not(edad<18)) #Respuesta: Muestra True
...
s="   hola, ¿como estas?"
#1:
s[::-1] #Respuesta: ?satse omoc¿ ,aloh

#2:
s[len(s)] #Respuesta: error

#3:
s.count("o") #Respuesta: 2

#4:
s.count("Hola") #Respuesta: 0

#5: 
s[-4] #Respuesta: tas

#6:
s[15:] #Respuesta: estas?

#7:
s.find("o") #Respuesta: 4

#8:
s.strip() #Respuesta: hola, ¿como estas?
...
#10:
s[14:].upper #Respuesta: " ESTAS?"

#11:
len(s)%2!=0 #Respuesta:

#12:
s.replace(" ", "*") #Respuesta:"***hola,*¿como*estas?"

#13:
s.replace("z", "Z") #Respuesta: "   hola, ¿como estas?"
